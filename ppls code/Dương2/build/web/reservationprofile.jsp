...
<html>
    ...
    <div class="wrapper">
      <div class="profile">
        <a class="back " href="/ShoppingOnline/home"><i class="bi bi-house-door"></i> Back home</a>

        <div class="containner">
          <div class="borrow-list">
            <h5 style="margin-top: 20px; margin-left: 10px;">Reservation List:</h5>
            <div class="content row">
                <c:forEach items="${requestScope.listBook}" var="b">
                    <div class="card col-md-4" style="width: 18rem;">
                        <img src="image/no-avatar.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">${b.isIs_accept()?'accepted':'not accepted'}</h5>
                        </div>
                    </div>
                </c:forEach>
            </div>
