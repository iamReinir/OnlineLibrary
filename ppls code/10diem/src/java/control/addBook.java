        ...
        String bookId=(String)request.getAttribute("bookID");
         String bookTitle=(String)request.getAttribute("bookTitle");
          String bookAuthor=(String)request.getAttribute("bookAuthor");
           String bookYear =(String)request.getAttribute("bookYear ");
            String bookSummary=(String)request.getAttribute("bookSummary");
        MethodBook m= new MethodBook();
        m.Addbook(bookId, bookTitle, bookAuthor, bookYear, bookSummary);
